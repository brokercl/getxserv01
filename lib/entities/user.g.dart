...
User _userDeserialize(
  ...
  final object = User(
    ...
    role: _UserroleValueEnumMap[reader.readByteOrNull(offsets[2])] ?? Rol.admin,
    status: _UserstatusValueEnumMap[reader.readByteOrNull(offsets[3])] ??
        StatusUser.active,
  );
  return object;
}
...
P _userDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readStringOrNull(offset)) as P;
    case 2:
      return (_UserroleValueEnumMap[reader.readByteOrNull(offset)] ?? Rol.admin)
          as P;
    case 3:
      return (_UserstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          StatusUser.active) as P;
    default:
...
const _UserstatusValueEnumMap = {
  0: StatusUser.active,
  1: StatusUser.pending,
  2: StatusUser.deleted,
  3: StatusUser.suspended,
};
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> roleEqualTo(Rol value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'role',
        value: value,
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> teacher(
      FilterQuery<Course> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> teacherLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> teacherIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'teacher', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> teacherIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'teacher', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> teacherLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> teacherLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> teacherLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, Rol, QQueryOperations> roleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'role');
    });
  }

  QueryBuilder<User, StatusUser, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
